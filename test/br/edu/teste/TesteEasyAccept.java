...
public class TesteEasyAccept {
	...
	public static void main(String[] args) throws Exception {
		...
		files.add("web/scripts/US01.txt");
		files.add("web/scripts/US02.txt");
		files.add("web/scripts/US03.txt");
		files.add("web/scripts/US04.txt");
		files.add("web/scripts/US05.txt");
		files.add("web/scripts/US06.txt");
		files.add("web/scripts/US07.txt");
		files.add("web/scripts/US08.txt");
		files.add("web/scripts/US09.txt");
		files.add("web/scripts/US10.txt");
		files.add("web/scripts/US11.txt");
		//files.add("web/scripts/US12.txt");
