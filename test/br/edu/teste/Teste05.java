...
public class Teste05 {
    ...
    public void testCriaUsuario() {
        ...
        try {
            Assert.assertEquals(40, meleva.cadastrarCarona("1", "Campina Grande", "João Pessoa",
                    "02/08/2012", "12:00", "3"));
        } catch (Exception e1) {
        ...
        try {
            Assert.assertEquals(50, meleva.cadastrarCarona("1", "Campina Grande", "João Pessoa",
                    "04/08/2012", "16:00", "2"));
        } catch (Exception e1) {
