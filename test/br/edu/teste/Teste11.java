	...
	public void test() {
		...
		try {
			Assert.assertEquals(1000, meleva.cadastrarInteresse("1",
					"João Pessoa", "Campina Grande", "23/08/2012", "06:00",
					"16:00"));
		...
		try {
			Assert.assertEquals(2000, meleva.cadastrarInteresse("2",
					"Campina Grande", "João Pessoa", "25/08/2012", "11:00",
					"18:00"));
		...
		try {
			Assert.assertEquals(3000, meleva.cadastrarInteresse("4",
					"Campina Grande", "João Pessoa", "23/08/2012", "", "18:00"));
		...
		try {
			Assert.assertEquals("5000", meleva.cadastrarInteresse("1", "-",
					"João Pessoa", "23/08/2012", "06:00", "16:00"));
			Assert.fail();
		} catch (Exception e1) {
		...
		try {
			Assert.assertEquals("5000", meleva.cadastrarInteresse("1",
					"Campina Grande", "!", "23/08/2012", "06:00", "16:00"));
			Assert.fail();
		} catch (Exception e1) {
		...
		try {
			Assert.assertEquals(20, meleva.cadastrarCarona("3", "João Pessoa",
					"Campina Grande", "25/08/2012", "14:00", "4"));
		...
		try {
			Assert.assertEquals(30, meleva.cadastrarCarona("4", "João Pessoa",
					"Campina Grande", "25/08/2012", "15:00", "1"));
		...
		try {
			Assert.assertEquals(
					"[Carona cadastrada no dia 23/08/2012, às 16:00 de acordo com os seus interesses registrados. Entrar em contato com jucaPeroba@gmail.com]",
