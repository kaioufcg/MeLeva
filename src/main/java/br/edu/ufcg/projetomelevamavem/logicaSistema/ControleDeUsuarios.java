...
public class ControleDeUsuarios implements Serializable {
     ...
     * @throws MeLevaException - Exceções para o caso dos dados inseridos sejam inválidos.
     */
     ...
     * @param senha
     *            - Senha do usuário a ser adicionado.
    ...
    public String visualizarPerfil(String iDSessao, String login)
        ...
        return "Perfil de " + usuario.getLogin().substring(0, 1).toUpperCase()
     ...
     * 
     * @param usuariosCadastradosPorLogin
     *            - Lista de usuários.
     */
     ...
     * 
     * @param login
     *            - Login do usuário a ser acessado.
