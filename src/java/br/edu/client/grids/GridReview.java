 ...
 * @author
 */
public class GridReview implements IsWidget {
     ...
     * @param sessao
     */
    public GridReview(String usuarioLogado, String sessao) {
    ...
    public Widget asWidget() {
        ...
        grid.filterData(new Criteria("dono_carona", usuarioLogado));
        donoField.setCanFilter(false);

        //botoes
        // Add a drop box with the list types
        final ListBox dropBox = new ListBox(false);
        String[] listTypes = new String[]{"não faltou", "faltou"};
        ...
        revisarButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                final Object login = record.getAttributeAsObject("login_caroneiro");
                servico.reviewVagaEmCarona(sessao, idCarona.toString(), login.toString(), dropBox.getItemText(dropBox.getSelectedIndex()), new AsyncCallback<String>() {
