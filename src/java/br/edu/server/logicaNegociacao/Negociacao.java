...
import br.edu.server.logicaSistema.ControleDeUsuarios;
...
public class Negociacao implements Serializable {
     ...
     *
     */
    private static final long serialVersionUID = 575124809122231381L;
    ...
    public void desistirRequisicao(String iDSessao, String iDCarona,
        ...
        NegociacaoDePonto sugestaRemover = null;
    ...
    public String getPontosDeEmbarque(String idCarona) throws MeLevaException {
        ...
        NegociacaoDePonto sugesta = null;
        while (sugestaoIt.hasNext()) {
            NegociacaoDePonto nextSugestao = sugestaoIt.next();
            if (String.valueOf(nextSugestao.getCarona().getId()).equals(
                    nextSugestao.getCarona().getId())) {
    ...
    public void iniciarContadores() {
        int negociacoes = solicitacoesConfirmadas.size() + solicitacoesPendentes.size();
        NegociacaoDePonto.iniciaContador(negociacoes);
    }

    public Map<Integer, NegociacaoDePonto> getSugestoesPontoDeEncontro() {
        return sugestoesPontoDeEncontro;
    }

    public Map<Integer, NegociacaoDePonto> getRespostasSugestaoPontoEncontro() {
        return respostasSugestaoPontoEncontro;
    }
}
