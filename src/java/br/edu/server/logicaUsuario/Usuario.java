package br.edu.server.logicaUsuario;
...
import br.edu.server.logicaSistema.ControleDeInteresse;
import br.edu.server.logicaSistema.MailSender;
...
public class Usuario implements Serializable {
     ...
     *
     */
    private static final long serialVersionUID = 5114558934516590944L;
    ...
    /**
     * Método que inicia os identificadores.
     *
     * @param numeroIdentificadores - Numero total de usuarios cadastrados que
     * referencia aos identificadores.
     */
    public static void iniciazeraCont(int numeroIdentificadores) {
        contadorId = numeroIdentificadores;
    }
}
