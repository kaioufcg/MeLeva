...
public class TestaCarona {
    ...
    public void construtorTest() throws Exception {
        ...
        try {
            Carona carona = new Carona(null, "Joao Pessoa", "23/10/2012", "12:00", 5);
        ...
        try {
            Carona carona = new Carona("", "Joao Pessoa", "19/10/2012", "12:00", 5);
        ...
        try {
            Carona carona = new Carona("            ", "Campina Grande", "19/10/2012", "12:00",
                    5);
        ...
        try {
            Carona carona = new Carona(" 2 5 7", "Campina Grande", "23/05/2012", "12:00", 5);
        ...
        try {
            Carona carona = new Carona("()*/", "Campina Grande", "23/05/2012", "12:00", 5);
            // Assert.fail("Teste de Origem = 2 5 7 falhou!");
        } catch (Exception e) {
            Assert.assertEquals("Origem inválida", e.getMessage());
        }
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", null, "19/10/2012", "12:00", 5);
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "  2 5 7", "23/05/2012", "12:00", 5);
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "()*/", "23/05/2012", "12:00", 5);
            // Assert.fail("Teste de Destino = 2 5 7 falhou!");
        } catch (Exception e) {
            Assert.assertEquals("Destino inválido", e.getMessage());
        }
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "Campina grande", null, "12:00", 5);
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "Campina grande", "", "12:00", 5);
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "Campina grande", "2 5 7", "12:00", 5);
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "Campina grande", "19/122010", "12:00", 5);
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "Campina grande", "19122010", "12:00", 5);
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "Campina grande", "19/12/2015", null, 5);
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "Campina grande", "19/12/2015", "", 5);
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "Campina grande", "19/12/2015",
                    "        ", 5);
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "Campina grande", "19/12/2015", "191:00",
                    5);
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "Campina grande", "19/12/2015", "25:00",
                    5);
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "Campina grande", "19/12/2015", "01:121",
                    5);
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "Campina grande", "19/12/2015", "01:60",
                    5);
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "Campina grande", "19/12/2015", "0100", 5);
        ...
        try {
            Carona carona = new Carona("Joao Pessoa", "Campina grande", "19/12/2015", "01:00",
                    null);
        ...
        // Carona carona = Carona carona = new Carona("Rio Grande do sul", "Coxixola",
        // "19/11/2023", "19:00", 1);
